  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full cursor-pointer rounded-md border border-slate-400 bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm transition hover:bg-slate-200 active:translate-y-px dark:border-slate-500 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700"
        >
          Sign up
        </button>
      ...
      <p className="mt-4 text-sm text-slate-700 dark:text-slate-300">
        ...
        <Link href="/login" className="font-semibold text-blue-700 dark:text-blue-300">
          Log in
        </Link>
      </p>
    </main>
